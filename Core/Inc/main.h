...
#define BUUTON_FC_RACE_MODE_Pin GPIO_PIN_5
#define BUUTON_FC_RACE_MODE_GPIO_Port GPIOB
#define BUUTON_FC_RACE_MODE_EXTI_IRQn EXTI9_5_IRQn
#define BUTTON_FC_PREPARE_TO_RACE_Pin GPIO_PIN_6
#define BUTTON_FC_PREPARE_TO_RACE_GPIO_Port GPIOB
#define BUTTON_FC_PREPARE_TO_RACE_EXTI_IRQn EXTI9_5_IRQn
#define BUTTON_FC_OFF_Pin GPIO_PIN_7
#define BUTTON_FC_OFF_GPIO_Port GPIOB
#define BUTTON_FC_OFF_EXTI_IRQn EXTI9_5_IRQn
